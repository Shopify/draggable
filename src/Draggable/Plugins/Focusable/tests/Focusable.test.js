...
describe('Focusable', () => {
  ...
  test('is included by default', () => {
    ...
    const focusablePlugin = draggable.plugins
      .find((plugin) => plugin.constructor === Focusable);

    expect(focusablePlugin).toBeInstanceOf(Focusable);
  });

  test('sets tabindex properties', () => {
    draggable = new Draggable(containers, {
      draggable: 'li',
    });
  ...
  test('removes tabindex properties', () => {
    draggable = new Draggable(containers, {
      draggable: 'li',
    });
  ...
  test('does not remove tabindex properties for natively focusable elements', () => {
    draggable = new Draggable(containers, {
      draggable: 'li, button',
    });
  ...
  test('does not remove tabindex properties for element with tabindex attribute', () => {
